 ...
 */
public class TestBetterDictionary {
    ...
    public static void main(String[] args) {
        BetterDictionary dict = new BetterDictionary(N*2);
        String[] tableStr;
        ...
        for (int i = 0; i < N*2; i++) {
            ...
            if (i > N) search_element += "#"; // quater of the strings should not be found
        ...
        dict.del(tableStr[0]);
        //System.out.println(tableStr[0]);
        dict.del(tableStr[N*2-1]);
        //System.out.println(tableStr[N-1]);
